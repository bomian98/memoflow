...
void main() {
  ...
  test('macOS public shell keeps system menu semantics and no commercial leakage', () {
    ...
    expect(
      appDelegate.contains('if !flag || memoFlowMainWindow?.isVisible != true'),
      isTrue,
    );
    ...
    expect(mainFlutterWindow.contains('WindowManagerPlugin.register'), isFalse);
    ...
    for (final file in <MapEntry<String, String>>[
      MapEntry('memos_flutter_app/macos/Runner/AppDelegate.swift', appDelegate),
      MapEntry(
        'memos_flutter_app/macos/Runner/MainFlutterWindow.swift',
        mainFlutterWindow,
      ),
