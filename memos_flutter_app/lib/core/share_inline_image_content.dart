...
import 'share_inline_image_url_rewriter.dart';
import 'url.dart';
...
String replaceShareInlineImageReferenceWithPlaceholder(
  String content, {
  required String localUrl,
  required String placeholder,
}) {
  if (localUrl.trim().isEmpty || placeholder.trim().isEmpty) return content;
  var next = _replaceHtmlImageTag(content, localUrl, placeholder);
