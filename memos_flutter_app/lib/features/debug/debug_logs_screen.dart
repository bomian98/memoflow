            ...
            return Container(
              ...
              child: ListView(
                ...
                children: [
                  ...
                  if (entry.requestHeaders != null) _DetailBlock(title: context.t.strings.legacy.msg_request_headers, content: entry.requestHeaders!, textMain: textMain, textMuted: textMuted),
                  if (entry.requestBody != null) _DetailBlock(title: context.t.strings.legacy.msg_request_body, content: entry.requestBody!, textMain: textMain, textMuted: textMuted),
                  if (entry.responseHeaders != null) _DetailBlock(title: context.t.strings.legacy.msg_response_headers, content: entry.responseHeaders!, textMain: textMain, textMuted: textMuted),
                  if (entry.responseBody != null) _DetailBlock(title: context.t.strings.legacy.msg_response_body, content: entry.responseBody!, textMain: textMain, textMuted: textMuted),
                  if (entry.error != null) _DetailBlock(title: context.t.strings.legacy.msg_error, content: entry.error!, textMain: textMain, textMuted: textMuted),
                ],
              ),
            );
          },
