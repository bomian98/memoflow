...
class MemoApiFacade {
  static MemosApi unauthenticated({
    ...
    return switch (version) {
      ...
      MemoApiVersion.v029 => MemoApi029.unauthenticated(
        baseUrl,
        logStore: logStore,
        logBuffer: logBuffer,
        breadcrumbStore: breadcrumbStore,
  ...
  static MemosApi authenticated({
    ...
    return switch (version) {
      ...
      MemoApiVersion.v029 => MemoApi029.authenticated(
        baseUrl: baseUrl,
        personalAccessToken: personalAccessToken,
        logStore: logStore,
        logBuffer: logBuffer,
  ...
  static MemosApi sessionAuthenticated({
    ...
    return switch (version) {
      ...
      MemoApiVersion.v027 => MemoApi027.sessionAuthenticated(
        baseUrl: baseUrl,
        sessionCookie: sessionCookie,
        logStore: logStore,
        logBuffer: logBuffer,
      ...
      MemoApiVersion.v029 => MemoApi029.sessionAuthenticated(
        baseUrl: baseUrl,
        sessionCookie: sessionCookie,
        logStore: logStore,
        logBuffer: logBuffer,
  ...
  static Future<MemoPasswordSignInResult> passwordSignIn({
    ...
    return switch (version) {
      ...
      MemoApiVersion.v027 => MemoApi027.passwordSignIn(
        baseUrl: baseUrl,
        username: username,
        password: password,
      ),
      ...
      MemoApiVersion.v029 => MemoApi029.passwordSignIn(
        baseUrl: baseUrl,
        username: username,
        password: password,
      ),
  ...
  static MemosApi authenticatedByVersionString({
    ...
    final parsed = parseMemoApiVersion(version) ?? MemoApiVersion.v029;
