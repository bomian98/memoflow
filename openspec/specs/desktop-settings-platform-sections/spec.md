# desktop-settings-platform-sections Specification

## Purpose
TBD - created by archiving change generalize-desktop-settings-platform-sections. Update Purpose after archive.
## Requirements
