...
- [x] 1.4 确认 Windows / Android 走公开赞赏支持页，且赞赏不承诺数字功能、权益、解锁或服务交换；桌面端展示二维码，移动端直接打开链接。
- [x] 1.5 确认公开赞赏移除旧 `donation_qr.png` 展示与保存流程，首版使用支付宝外部支持链接 `https://qr.alipay.com/tsx16856ygfke5rugz1ao4a`，桌面端由该链接动态生成二维码。
